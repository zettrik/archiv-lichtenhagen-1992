...
class zotero_csv:
    ...
    def get_raw_csv_data(self):
        ...
        """
        zotero_csv_export = open(self.file,'r')
        try:
            csv_raw_data = list(csv.reader(zotero_csv_export))

        finally:
            zotero_csv_export.close()
    ...
    def get_prepared_csv_data(self):
        ...
        #print("Original head of csv file: ")
        #print(csv_data[0][0:])
...
if __name__ == "__main__":
    try:
        ...
        print("usage: %s export.csv" % sys.argv[0])
        sys.exit(1)

    foo = zotero_csv(filename)
